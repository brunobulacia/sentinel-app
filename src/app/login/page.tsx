...
export default function LoginPage() {
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError('AUTH_FAILED: Invalid credentials detected.');
    } finally {
      setSubmitting(false);
    }
  };
      ...
      >
        <div className="text-center mb-10">
          ...
          <p className="text-neon-cyan/70 font-mono text-sm mt-2 tracking-widest uppercase">
            <ScrambleText text="SecOps Terminal Access" delay={800} />
          </p>
        </div>

        <div className="relative group">
          {/* Borde brillante animado suavizado */}
          ...
          <div className="relative glass-panel rounded-xl p-8 bg-slate-900/90 border-slate-800">
            <div className="flex items-center gap-3 mb-8">
              ...
              <h2 className="text-xl font-mono text-slate-200 tracking-widest">SYSTEM_LOGIN</h2>
            </div>
            ...
            <form onSubmit={submit} className="space-y-5">
              <div>
                <label className="block text-xs font-mono text-slate-400 mb-2 uppercase tracking-wider">Identidad (Email)</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="operator@sys.local"
              ...
              <div>
                <label className="block text-xs font-mono text-slate-400 mb-2 uppercase tracking-wider">Clave de Acceso</label>
                <div className="relative">
            ...
            <div className="mt-8 pt-6 border-t border-slate-800 text-center">
              <p className="text-xs text-slate-500 font-mono">
                ¿NUEVO OPERADOR?{' '}
                <Link href="/register" className="text-neon-cyan hover:text-white transition-colors hover:drop-shadow-[0_0_8px_rgba(0,240,255,0.8)]">
                  SOLICITAR ACCESO
                </Link>
              </p>
            </div>
